# Task Charter — WP35: Chaos suite II

**Charter Status:** `SPEC_COMPLETE`
**WP:** WP35
**Phase:** P3
**task_mode:** `standard`
**Depends on:** WP29, WP33
**W4 Test Targets:** `0`
...
- **Outcome:** the session-boundary and mode classes are covered by self-discriminating tests.
- **BUILD_SPEC reference:** `workflowArtifacts/canvas-v2/BUILD_SPEC_CanvasV2.md` — section 5, component **C35 — Chaos suite II (P2/P3 scenarios)** (work package WP35); phase **P3**.
...
- **In scope:**
  ...
  - Scope summary: host rejoin, fallback-coexistence, with discrimination
- **Out of scope / non-goals:**
  - Production changes to make a scenario pass — a red scenario is a finding.
...
- **Known interfaces / dependencies:**
  ...
  - Depends on work packages: WP29, WP33
...
- **Component(s) being changed:** Chaos suite II (P2/P3 scenarios)
- **Interfaces involved:**
  - Input: injected sidecar and mode seams
  - Output: named deterministic suites
...
- **Entry points / relevant files (from `workflowArtifacts/RepoMap.md`, V2 Touchpoint Inventory):**
  - `plugin/src/__tests__/harness/two-peer.ts` and `harness/canvas-double.ts`
...
*Exact copy from BUILD_SPEC section 5, component C35. No paraphrasing.*
...
- **Required report:** `ImplementationReport_WP35.md` (in `workflowArtifacts/canvas-v2/`)
