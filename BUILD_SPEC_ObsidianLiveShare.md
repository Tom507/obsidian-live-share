...
The supported deployment is a self-hosted relay exposed through TLS with this access model:

- A deployment may optionally protect its credential or download page with a generic browser-based SSO or forward-auth service.
